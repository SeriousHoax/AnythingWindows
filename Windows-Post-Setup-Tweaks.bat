...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\FirewallRules" /v "{61112D6C-55F9-4CF0-8764-0A8652197DD2}" /t REG_SZ /d "v2.31|Action=Block|Active=TRUE|Dir=Out|App=E:\Portables\Ccleaner Portable\x64\CCleaner64.exe|Name=Ccleaner|" /f
