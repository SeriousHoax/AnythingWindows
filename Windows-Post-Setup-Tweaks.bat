...
reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\FirewallRules" /v "{61112D6C-55F9-4CF0-8764-0A8652197DD2}" /t REG_SZ /d "v2.31|Action=Block|Active=TRUE|Dir=Out|App=E:\Portables\Ccleaner Portable\x64\CCleaner64.exe|Name=Ccleaner|" /freg add "HKLM\SYSTEM\ControlSet001\Services\SharedAccess\Parameters\FirewallPolicy\FirewallRules" /v "{6D98561A-44DF-455B-A0D2-7830DA49ACBC}" /t reg_SZ /d "v2.31|Action=Block|Active=TRUE|Dir=In|Protocol=6|Profile=Private|App=C:\Program Files\Mozilla Firefox\firefox.exe|Name=Firefox (C:\Program Files\Mozilla Firefox)|" /f
