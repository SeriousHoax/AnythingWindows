...
reg add "HKLM\SOFTWARE\Policies\Microsoft\WindowsFirewall\FirewallRules" /v "{f016bbe0-a716-428b-822e-5E544B6A3101}" /t reg_SZ /d "v2.29|Action=Block|Active=TRUE|Dir=Out|App=E:\Portables\Ccleaner Portable\CCleaner.exe|Name=H_C rule for: CCleaner.exe|EmbedCtxt=H_C Firewall Rules|" /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\WindowsFirewall\FirewallRules" /v "{f016bbe0-a716-428b-822e-5E544B6A3102}" /t reg_SZ /d "v2.29|Action=Block|Active=TRUE|Dir=Out|App=E:\Portables\Ccleaner Portable\CCleaner64.exe|Name=H_C rule for: CCleaner64.exe|EmbedCtxt=H_C Firewall Rules|" /f
